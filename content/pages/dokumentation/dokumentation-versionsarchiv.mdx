...
Im Jahr 2025 hat die Zeitung "Österreich" die Berechtigung zur Speicherung ihrer Daten zurückgezogen. 
Daher ist dieses Medium seit Version *amc_4.25q5LTSx* in allen neu gebauten Korpora nicht mehr enthalten. 
...
Diese neuen Versionen tragen nun den Namenszusatz "x". D.h. aus "amc_4.3" wurde ein (um "Österreich" bereinigtes) "amc_4.3x". 
Die Originalversionen werden nach einer kurzen "grace period" mit Ende 03/2026 vollständig entfernt.   

**ACHTUNG**: versionen amc_4.1 amc_4.2 amc_4.3 amc_4.24q4LTS werden im März 2026 entfernt und durch ihre bereits verfügbaren "x"-Varianten ersetzt!

**Vorhaltung älterer Versionen**

Mit den kürzeren Updatezyklen wird es also ab nun 4 neue Versionsschritte pro Jahr geben. Wir können nicht garantieren, dass wir all diese Versionen mit vergleichsweise geringfügigen Änderungsschritten "ewig" in der NoSke vorhalten werden. Es ist aber geplant, zumindest einmal jählich eine *long term supported (LTS)* Version bereitzustellen. Für diese wird die Langzeitverfügbarkeit auf Dauer gewährleistet sein. Als LTS sind diejenigen Versionen vorgesehen, die das Quartal 4 – also ein abgeschlossenes Jahr – enthalten, und diese Versionen werden auch mit dem Namenszusatz `LTS` versehen sein.
...
** Versionen zur baldigen Skartierung! **
 ...
 Archivierte quantitative Informationen zu älteren Versionen **die mit 2026-03-31 entfernt werden**
...
## <span id="amc_43x">amc\_4.3x</span>
(bis incl. 2023-12)
...
** Versionen zur baldigen (2026-03) Skarktierung! **

## <span id="amc25q3">amc\_4.24q3</span>
...
## <span id="amc25q2">amc\_4.24q2</span>
...
****
## <span id="amc25q1">amc\_4.24q1</span>
...
****
## <span id="amc24q3">amc\_4.24q4LTS</span>
...
****
## <span id="amc24LTS">amc\_4.24q3</span>
